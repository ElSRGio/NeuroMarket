    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-brand-darker">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Empieza a analizar tu inversión hoy</p>
        </div>
        ...
        <p className="text-center text-gray-500 mt-4 text-sm">
          ¿Ya tienes cuenta?{' '}
          <Link to="/login" className="text-brand-blue hover:underline">Iniciar sesión</Link>
        </p>
      </div>
    </div>
  )
