...
const NAV_DROPDOWN = {
  'Por que XAZIA': [
    ...
    { title: 'XAZIA + INEGI', desc: 'Datos oficiales de poblacion, empleo y bancarizacion integrados.' },
  ],
  'Nuestra plataforma': [
    ...
    { title: 'API REST', desc: 'Integra XAZIA con tus sistemas existentes (plan Enterprise).' },
  ],
}
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-gray-600 font-medium">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-0 w-72 bg-white rounded-xl shadow-xl border border-gray-100 py-3 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 translate-y-1 group-hover:translate-y-0">
                {NAV_DROPDOWN['Por que XAZIA'].map((item, i) => (
                  <div key={i}>
            ...
            <span className="text-gray-900 border-b-2 border-green-500 pb-0.5">Inicio</span>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white px-4 pb-4">
            <div className="pt-3 space-y-1">
              ...
              <p className="text-xs font-bold text-gray-400 uppercase tracking-wider px-3 pt-2 pb-1">Por que XAZIA</p>
              {NAV_DROPDOWN['Por que XAZIA'].map((item, i) => (
              ...
              <span className="block px-3 py-2 text-sm font-bold text-gray-900">Inicio</span>
              <div className="border-t border-gray-100 my-2"/>
              {!user ? (
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="text-white">
            <h2 className="text-3xl sm:text-4xl font-black mb-5 leading-tight">
              Quieres ver<br/>
              <span style={{ color: '#4ade80' }}>XAZIA en</span><br/>
              <span style={{ color: '#4ade80' }}>accion?</span>
            </h2>
            <p className="text-gray-300 font-semibold text-base sm:text-lg mb-3">
              Descubre como XAZIA puede ayudarte a tomar mejores decisiones de inversion.
            </p>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-2xl">
            ...
            <p className="text-xs text-gray-400 mt-4">
              Proyecto academico XAZIA - Ing. en Sistemas 2026.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-400">
                2026 XAZIA. Proyecto academico - Ingenieria en Sistemas, Libres, Puebla.
              </span>
            </div>
